...
*  1209016337@qq.com
*
*  功能:kswDeque的迭代器的实现代码
******************************************************************/

#ifndef _KSW_DEQUE_ITERATOR_
#define _KSW_DEQUE_ITERATOR_
...
#pragma region typedef和成员变量的定义
		...
		typedef T**			map_pointer; // 迭代器所属缓冲区，该缓冲区由kswDeque的管控中心管理
		...
		T* first; // 缓冲区头部
		T* last; // 缓冲区尾部
		map_pointer	node; // 迭代器所属缓冲区，该缓冲区由kswDeque的管控中心管理

#pragma endregion

#pragma region 迭代器管控中心和kswDeque管控中心的衔接

		/*
		输入参数：new_node，kswDeque传过来的缓冲区位置（管控中心的某个节点）
		*/
		void set_node(map_pointer new_node)
		{
			node = new_node; // 连接kswDeque管控中心的某个节点和迭代器缓冲区
